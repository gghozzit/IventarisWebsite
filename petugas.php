	...
	<div class="page-wrapper">
                ...
                <nav class="navbar-sidebar2">
                    <ul class="list-unstyled navbar__list">
                        ...
                        <li>
                            ...
                            <i class="fas fa-archive"></i>Tambah Inventaris</a>
                        </li>
                    </ul>
                </nav>
            </div>
		...
		<div class="page-container2">
            ...
            <aside class="menu-sidebar2 js-right-sidebar d-block d-lg-none">
                <div class="logo">
                    <a href="#">
                        <img src="images/icon/logo-white.png" alt="petugas" />
                    </a>
                </div>
                <div class="menu-sidebar2__content js-scrollbar2">
                    ...
                    <div>
                        <h4 style="color:aliceblue" class="name"><?= $auth['nama_user'] ?></h4>
                        <a href="#">Sign out</a>
                    </div>
                    <nav class="navbar-sidebar2">
                        <ul class="list-unstyled navbar__list">
                            ...
                            <li>
                                <a href="?page=viewBarang">
                                <i class="fas fa-archive"></i>Inventaris</a>
                            </li>
                        </ul>
                    </nav>
                </div>
